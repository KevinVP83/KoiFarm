...
public class KoiFarmTest {
	...
	public void testSellKoiKoiSellerKoiKeeperint() {
		...
		assertEquals(1, seller.getCompletedSales().size(), "Test sell() 01 failed");
		...
		try {
			...
			assertEquals("java.util.NoSuchElementException", e.getClass().getName(), "Test sell() 03 failed");
		}
		assertEquals(1, seller.getCompletedSales().size(), "Test sell() 04 failed");
		...
		try {
			...
			assertEquals("java.util.NoSuchElementException", e.getClass().getName(), "Test sell() 06 failed");
		}
		assertEquals(0, seller2.getCompletedSales().size(), "Test sell() 07 failed");
		...
		try {
			...
			assertEquals("java.util.NoSuchElementException", e.getClass().getName(), "Test sell() 09 failed");
		}
		assertEquals(1, seller.getCompletedSales().size(), "Test sell() 10 failed");
	...
	public void testSellMapKoiSellerKoiKeeper() {
		...
		assertEquals(1, seller.getCompletedSales().size(), "Test sell() 07 failed");
		...
		try {
			...
			assertEquals("java.util.NoSuchElementException", e.getClass().getName(), "Test sell() 00 failed");
		}
		assertEquals(0, seller2.getCompletedSales().size(), "Test sell() 10 failed");
	...
	public void testBuy() {
		...
		try {
			...
			assertEquals("java.lang.IllegalStateException", e.getClass().getName(), "Test buy() 02 failed");
		}
	...
	public void testGetKoisSoldBySeller() {
		...
		assertEquals(3, farm.getKoisSoldBySeller(seller).size(), "Test getKoisSoldBySeller() 01 failed");
	}
	...
	public void testGetBoughtPrice() {
		...
		farm.buy(koi, new BigDecimal(50));
		farm.buy(koi2, new BigDecimal(100));
		assertEquals(new BigDecimal(50), farm.getBoughtPrice(koi), "Test getBoughtPrice() 01 failed");
		assertEquals(new BigDecimal(100), farm.getBoughtPrice(koi2), "Test getBoughtPrice() 02 failed");
	}
	...
	public void testGetBenefitsDoneBySeller() {
		...
		assertEquals(new BigDecimal(300), farm.getBenefitsDoneBySeller(seller), "Test getBenefitsDoneBySeller() 01 failed");
	}
	...
	public void testAddSeller() {
		...
		KoiSeller seller = new KoiSeller("Pierre");
		assertEquals(0, farm.getSellerCollection().size(), "Test addSeller() 01 failed");

		farm.addSeller(seller);
		assertEquals(1, farm.getSellerCollection().size(), "Test addSeller() 02 failed");

		farm.addSeller(seller);
		assertEquals(1, farm.getSellerCollection().size(), "Test addSeller() 03 failed");
	}
	...
	public void testAddKeeper() {
		...
		assertEquals(0, farm.getKeeperCollection().size(), "Test addKeeper() 01 failed");

		farm.addKeeper(keeper);
		assertEquals(1, farm.getKeeperCollection().size(), "Test addKeeper() 02 failed");

		farm.addKeeper(keeper);
		assertEquals(1, farm.getKeeperCollection().size(), "Test addKeeper() 03 failed");
	}
}